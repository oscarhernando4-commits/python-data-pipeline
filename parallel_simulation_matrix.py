...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`$20.07 USD`** | **`{active_crypto}`** | `#{real_st['trades_count']}` | **`${real_st['current_balance_usd']:.2f} USD`** | **`${real_st['net_pnl_usd']:+,.2f} USD`** | `{real_st['wins']}W/{real_st['losses']}L` | **`{real_st['status']}`** |
