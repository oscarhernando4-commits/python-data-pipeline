...
res = requests.get('https://fapi.binance.com/fapi/v2/positionRisk', headers=headers, params=p, proxies=rmt.PROXIES, timeout=10)
try:
    positions = [pp for pp in res.json() if float(pp.get('positionAmt', 0)) != 0]
