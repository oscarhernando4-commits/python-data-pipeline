...
| **15 Minutos (Gatillo de Entrada)** | Señal técnica y gatillo | 🟢 Expansión | RSI=55.1, MACD Hist=-0.0000 |
| **1 Hora (Intradía)** | Rango y consolidación | 🟢 Sobre EMA20 | Soporte intradía clave en $0.3280 |
| **4 Horas (Macro Institucional)** | Tendencia mayor de ballenas | **🟢 ALCISTA (Bullish)** | EMA50: $0.3282 - EMA200: $0.3282 |
...
* **Cuerpo de la Vela:** `0.000200 USD` (Fuerza direccional del ciclo)
...
| :--- | :--- | :--- | :--- |
| **RSI (14) - 15 Minutos** | **`55.15`** | 30 - 70 | 🔵 Zona Neutral Saludable |
| **RSI (14) - 4 Horas** | **`55.73`** | 30 - 70 | 🟢 Macro Alcista |
| **MACD Histograma (15m)** | **`-0.000002`** | Oscilador | 🔴 Presión Vendedora |
| **EMA 20 (Soporte Dinámico)** | **`$0.328172`** | Referencia | 🟢 Precio por encima (Fuerza) |
| **Bollinger Banda Superior** | **`$0.328611`** | Resistencia | Techo de volatilidad para toma de ganancias |
| **Bollinger Banda Inferior** | **`$0.327859`** | Soporte | Suelo de volatilidad para entradas de rebote |
| **Volumen Surge Ratio** | **`0.26x`** | > 1.50x | ⚪ Volumen Promedio / Normal |
| **ATR (Volatilidad Real 15m)** | **`$0.000250`** | Margen | Rango medio de movimiento por vela de 15m |

---

## 🛡️ 5. GESTIÓN DE RIESGO Y PARÁMETROS ASIMÉTRICOS (1:2)
* 🎯 **Take Profit Objetivo (+2.0%):** **`$0.334866 USD`**
* 🛑 **Stop Loss Inflexible (-1.0%):** **`$0.325017 USD`**
