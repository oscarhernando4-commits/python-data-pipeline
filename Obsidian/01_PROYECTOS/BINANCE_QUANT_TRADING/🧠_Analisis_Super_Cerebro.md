...
| **15 Minutos (Gatillo de Entrada)** | Señal técnica y gatillo | 🟢 Expansión | RSI=68.8, MACD Hist=+0.0000 |
| **1 Hora (Intradía)** | Rango y consolidación | 🟢 Sobre EMA20 | Soporte intradía clave en $0.0696 |
| **4 Horas (Macro Institucional)** | Tendencia mayor de ballenas | **🟢 ALCISTA (Bullish)** | EMA50: $0.0690 - EMA200: $0.0690 |
...
* **Mecha Superior (Presión Vendedora):** `0.000030 USD` (Indica rechazo en techos)
* **Cuerpo de la Vela:** `0.000150 USD` (Fuerza direccional del ciclo)
...
| :--- | :--- | :--- | :--- |
| **RSI (14) - 15 Minutos** | **`68.81`** | 30 - 70 | 🔴 Sobrecompra / Riesgo |
| **RSI (14) - 4 Horas** | **`59.56`** | 30 - 70 | 🟢 Macro Alcista |
| **MACD Histograma (15m)** | **`+0.000011`** | Oscilador | 🟢 Impulso Comprador Creciente |
| **EMA 20 (Soporte Dinámico)** | **`$0.069796`** | Referencia | 🟢 Precio por encima (Fuerza) |
| **Bollinger Banda Superior** | **`$0.070231`** | Resistencia | Techo de volatilidad para toma de ganancias |
| **Bollinger Banda Inferior** | **`$0.069309`** | Soporte | Suelo de volatilidad para entradas de rebote |
| **Volumen Surge Ratio** | **`0.87x`** | > 1.50x | ⚪ Volumen Promedio / Normal |
| **ATR (Volatilidad Real 15m)** | **`$0.000159`** | Margen | Rango medio de movimiento por vela de 15m |

---

## 🛡️ 5. GESTIÓN DE RIESGO Y PARÁMETROS ASIMÉTRICOS (1:2)
* 🎯 **Take Profit Objetivo (+2.0%):** **`$0.071492 USD`**
* 🛑 **Stop Loss Inflexible (-1.0%):** **`$0.069389 USD`**
