...
*Última actualización: `2026-08-02 06:00:50`*
...
| **15 Minutos (Gatillo de Entrada)** | Señal técnica y gatillo | 🟢 Expansión | RSI=59.5, MACD Hist=+0.0001 |
...
| :--- | :--- | :--- | :--- |
| **RSI (14) - 15 Minutos** | **`59.50`** | 30 - 70 | 🔵 Zona Neutral Saludable |
| **RSI (14) - 4 Horas** | **`44.94`** | 30 - 70 | 🔴 Macro Bajista |
| **MACD Histograma (15m)** | **`+0.000071`** | Oscilador | 🟢 Impulso Comprador Creciente |
| **EMA 20 (Soporte Dinámico)** | **`$0.067600`** | Referencia | 🟢 Precio por encima (Fuerza) |
| **Bollinger Banda Superior** | **`$0.068634`** | Resistencia | Techo de volatilidad para toma de ganancias |
| **Bollinger Banda Inferior** | **`$0.066686`** | Soporte | Suelo de volatilidad para entradas de rebote |
| **Volumen Surge Ratio** | **`0.00x`** | > 1.50x | ⚪ Volumen Promedio / Normal |
| **ATR (Volatilidad Real 15m)** | **`$0.000414`** | Margen | Rango medio de movimiento por vela de 15m |
