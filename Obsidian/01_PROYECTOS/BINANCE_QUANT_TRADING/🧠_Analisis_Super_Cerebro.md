...
*Última actualización: `2026-08-02 05:59:22`*
...
> - 💵 **Precio Actual de Mercado:** **`$0.068000 USD`**
...
| **15 Minutos (Gatillo de Entrada)** | Señal técnica y gatillo | 🟢 Expansión | RSI=58.8, MACD Hist=+0.0001 |
...
| :--- | :--- | :--- | :--- |
| **RSI (14) - 15 Minutos** | **`58.83`** | 30 - 70 | 🔵 Zona Neutral Saludable |
| **RSI (14) - 4 Horas** | **`44.94`** | 30 - 70 | 🔴 Macro Bajista |
| **MACD Histograma (15m)** | **`+0.000053`** | Oscilador | 🟢 Impulso Comprador Creciente |
| **EMA 20 (Soporte Dinámico)** | **`$0.067557`** | Referencia | 🟢 Precio por encima (Fuerza) |
| **Bollinger Banda Superior** | **`$0.068662`** | Resistencia | Techo de volatilidad para toma de ganancias |
| **Bollinger Banda Inferior** | **`$0.066678`** | Soporte | Suelo de volatilidad para entradas de rebote |
| **Volumen Surge Ratio** | **`5.30x`** | > 1.50x | 🔥 Volumen Institucional Detectado |
...
* 🎯 **Take Profit Objetivo (+2.0%):** **`$0.069360 USD`**
* 🛑 **Stop Loss Inflexible (-1.0%):** **`$0.067320 USD`**
