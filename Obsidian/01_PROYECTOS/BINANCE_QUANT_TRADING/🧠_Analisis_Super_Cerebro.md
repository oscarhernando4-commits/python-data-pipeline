...
*Última actualización: `2026-08-02 05:55:48`*
...
> - 💵 **Precio Actual de Mercado:** **`$0.068100 USD`**
...
| **15 Minutos (Gatillo de Entrada)** | Señal técnica y gatillo | 🟢 Expansión | RSI=61.0, MACD Hist=+0.0001 |
...
* **Mecha Inferior (Absorción de Compras):** `0.000200 USD` (Indica si las ballenas compraron en la caída)
* **Mecha Superior (Presión Vendedora):** `0.000300 USD` (Indica rechazo en techos)
...
| :--- | :--- | :--- | :--- |
| **RSI (14) - 15 Minutos** | **`61.02`** | 30 - 70 | 🔵 Zona Neutral Saludable |
| **RSI (14) - 4 Horas** | **`45.30`** | 30 - 70 | 🔴 Macro Bajista |
| **MACD Histograma (15m)** | **`+0.000060`** | Oscilador | 🟢 Impulso Comprador Creciente |
| **EMA 20 (Soporte Dinámico)** | **`$0.067567`** | Referencia | 🟢 Precio por encima (Fuerza) |
| **Bollinger Banda Superior** | **`$0.068675`** | Resistencia | Techo de volatilidad para toma de ganancias |
| **Bollinger Banda Inferior** | **`$0.066675`** | Soporte | Suelo de volatilidad para entradas de rebote |
| **Volumen Surge Ratio** | **`2.76x`** | > 1.50x | 🔥 Volumen Institucional Detectado |
| **ATR (Volatilidad Real 15m)** | **`$0.000436`** | Margen | Rango medio de movimiento por vela de 15m |

---

## 🛡️ 5. GESTIÓN DE RIESGO Y PARÁMETROS ASIMÉTRICOS (1:2)
* 🎯 **Take Profit Objetivo (+2.0%):** **`$0.069462 USD`**
* 🛑 **Stop Loss Inflexible (-1.0%):** **`$0.067419 USD`**
