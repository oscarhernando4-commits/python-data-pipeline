...
*Última actualización: `2026-08-02 06:05:49`*
...
> - 💵 **Precio Actual de Mercado:** **`$0.067700 USD`**
...
| **15 Minutos (Gatillo de Entrada)** | Señal técnica y gatillo | 🟢 Expansión | RSI=53.3, MACD Hist=+0.0001 |
| **1 Hora (Intradía)** | Rango y consolidación | 🟢 Sobre EMA20 | Soporte intradía clave en $0.0677 |
...
* **Mecha Inferior (Absorción de Compras):** `0.000400 USD` (Indica si las ballenas compraron en la caída)
* **Mecha Superior (Presión Vendedora):** `0.000100 USD` (Indica rechazo en techos)
* **Cuerpo de la Vela:** `0.000300 USD` (Fuerza direccional del ciclo)
...
| :--- | :--- | :--- | :--- |
| **RSI (14) - 15 Minutos** | **`53.30`** | 30 - 70 | 🔵 Zona Neutral Saludable |
| **RSI (14) - 4 Horas** | **`43.86`** | 30 - 70 | 🔴 Macro Bajista |
| **MACD Histograma (15m)** | **`+0.000052`** | Oscilador | 🟢 Impulso Comprador Creciente |
| **EMA 20 (Soporte Dinámico)** | **`$0.067571`** | Referencia | 🟢 Precio por encima (Fuerza) |
| **Bollinger Banda Superior** | **`$0.068607`** | Resistencia | Techo de volatilidad para toma de ganancias |
| **Bollinger Banda Inferior** | **`$0.066683`** | Soporte | Suelo de volatilidad para entradas de rebote |
| **Volumen Surge Ratio** | **`2.49x`** | > 1.50x | 🔥 Volumen Institucional Detectado |
| **ATR (Volatilidad Real 15m)** | **`$0.000471`** | Margen | Rango medio de movimiento por vela de 15m |

---

## 🛡️ 5. GESTIÓN DE RIESGO Y PARÁMETROS ASIMÉTRICOS (1:2)
* 🎯 **Take Profit Objetivo (+2.0%):** **`$0.069054 USD`**
* 🛑 **Stop Loss Inflexible (-1.0%):** **`$0.067023 USD`**
