...
| :--- | :--- | :--- |
| 💵 **Capital Total (Fondo $10k):** | **`$10,021.25 USD`** | Balance de las 100 cuentas de prueba |
| 💰 **Ganancia Neta Total:** | **`$+21.25 USD`** | Resultado global acumulado |
| 🎯 **Cuentas que cumplieron la meta:** | **`20 de 100 Cuentas`** | Cuentas que alcanzaron el +3% esta semana |
| 📈 **Tasa de Acierto de la IA:** | **`32.14% Win Rate`** | Efectividad actual de las estrategias |
...
> - 🟢 **Rendimiento Compras (LONG):** `38.5%` de Acierto
> - 🔴 **Rendimiento Ventas (SHORT):** `26.6%` de Acierto
...
> - 💰 **Capital Promedio Actual:** `$100.21 USD`
...
> - 💵 **Balance Real Actual:** `$19.92 USD` (`+2.79 USD`)
> - 🪙 **Posición Activa:** `INJUSDT`
> - 🎯 **Estado Operativo:** `🔵 En Vivo LONG (INJUSDT @ $4.9990)`
...
| :--- | :--- | :--- | :--- |
| **EPICUSDT** | `$103.91 USD` | `$+3.91 USD` | 🔵 En Operación |
| **EPICUSDT** | `$103.91 USD` | `$+3.91 USD` | 🔵 En Operación |
| **EPICUSDT** | `$103.91 USD` | `$+3.91 USD` | 🔵 En Operación |
| **EPICUSDT** | `$103.91 USD` | `$+3.91 USD` | 🔵 En Operación |
| **EPICUSDT** | `$103.91 USD` | `$+3.91 USD` | 🔵 En Operación |
...
| **1 (Ultra-Estricto)** | `66.7%` | `$+57.40` |
| **Grupo 2** | `16.7%` | `$-97.60` |
| **Grupo 3** | `50.0%` | `$+34.00` |
| **Grupo 4** | `37.5%` | `$+78.20` |
| **5 (Exploratorio)** | `14.3%` | `$-46.55` |
