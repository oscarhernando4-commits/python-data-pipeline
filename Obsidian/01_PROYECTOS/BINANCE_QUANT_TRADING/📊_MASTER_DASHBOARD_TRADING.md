...
| :--- | :--- | :--- |
| 💵 **Capital Total (Fondo $10k):** | **`$9,850.34 USD`** | Balance de las 100 cuentas de prueba |
| 💰 **Ganancia Neta Total:** | **`$-149.66 USD`** | Resultado global acumulado |
| 🎯 **Cuentas que cumplieron la meta:** | **`20 de 100 Cuentas`** | Cuentas que alcanzaron el +3% esta semana |
| 📈 **Tasa de Acierto de la IA:** | **`21.81% Win Rate`** | Efectividad actual de las estrategias |
...
> - 🟢 **Rendimiento Compras (LONG):** `25.0%` de Acierto
...
> - 💰 **Capital Promedio Actual:** `$98.50 USD`
