...
> **Última Actualización:** `2026-08-01 04:11:18`  
...
| :--- | :--- | :--- |
| 💵 **Capital Total (Fondo $10k):** | **`$10,022.54 USD`** | Balance de las 100 cuentas de prueba |
| 💰 **Ganancia Neta Total:** | **`$+22.54 USD`** | Resultado global acumulado |
...
> - 💰 **Capital Promedio Actual:** `$100.23 USD`
...
> - 💵 **Balance Real Actual:** `$17.51 USD` (`-2.56 USD`)
> - 🪙 **Posición Activa:** `MMTUSDT`
> - 🎯 **Estado Operativo:** `🔵 En Vivo LONG (MMTUSDT)`
