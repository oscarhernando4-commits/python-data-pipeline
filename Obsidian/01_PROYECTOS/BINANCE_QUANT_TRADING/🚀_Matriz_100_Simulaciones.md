...
> - 💵 **Balance Total del Grupo:** `$1,975.06 USD` (`-$24.94`)
> - 🎯 **Operaciones Totales:** `1092` (`161 Ganadas / 925 Perdidas`)
...
| **SIM-064** | **HEIUSDT** | `#57` | `8W/49L` | 26-08-11<br>01:10 | `🔴 Perdió -$0.06` | **`$98.63`** (`-$1.37`) | 🔴 Buscando |
