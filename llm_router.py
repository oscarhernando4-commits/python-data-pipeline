...
def review_top_candidates(candidates_data_list, news_data, fear_greed, macro_context="", market_bias_ctx=""):
    ...
    3. 🌊 AGENTE 3 (Auditor de Libro, CVD & Squeeze Micro): Exige Bids >= 50.0%, Muro comprador > $20k USDT, CVD Taker positivo/neutral, Spread <= 0.18%, Vol Surge 1M >= 1.0x y OBV != DISTRIBUTING. VETA categóricamente activos con volumen muerto (Vol1M < 0.80x o Vol15M < 0.80x) o Muro Bids < $20k USDT.
    ...
    5. 🧠 AGENTE 5 (Memoria RAG & Auto-Aprendizaje Cuántico): Valida el ADN de la moneda, reputación histórica y patrones aprendidos. VETA permanentemente: (a) Monedas en Blacklist Dinámica (WR < 30%), (b) Mega-Caps / Zombis (TRX, BNB, BTC, ETH), (c) Micro-volumen muerto (<0.80x), (d) Distribución institucional, (e) Re-entradas en la misma moneda en menos de 4h. PREMIA cohetes con Vol1M >= 1.5x, FII >= 60 y Retesteo Ola 2 (como XLM, KAIA, COMP, DCR).
